...
Пиши только в таком формате, если да же не можешь определить, отвечай примерно, больше лишней информации не пиши. Больше никакую информацию не пиши. Отвечай точно как в примере
