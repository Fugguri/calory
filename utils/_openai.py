...
Пиши только в таком формате, если да же не можешь определить, отвечай примерно, больше лишней информации не пиши. Больше никакую информацию не пиши. Отвечай точно как в примере, ну нужно делать в формете таблицы, нужно чтобы все было текстом


Всего каллорий: {need_callory}
Отвечай в формате,только как в примере. Не меняй структуру ответа и не пиши лишней информации
Пример ответа:
